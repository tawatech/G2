...
void    G2bAdaFruitRA8875_800x480::DrawRoundedFilledRectangle(int16_t XPos,int16_t YPos,int16_t Width,int16_t Height,int16_t CornerRadius,uint16_t ButtonColor)
{
  AdaTFT->fillRoundRect(XPos, YPos, Width, Height, CornerRadius, ButtonColor);
}

void    G2bAdaFruitRA8875_800x480::DrawRoundedRect(int16_t XPos,int16_t YPos,int16_t Width,int16_t Height,int16_t CornerRadius,uint16_t ButtonBorder)
{
...
void	  G2bAdaFruitRA8875_800x480::DrawFillCircle(int16_t XPos, int16_t YPos, int16_t Radius, uint16_t Color)
{
	AdaTFT->fillCircle(XPos, YPos, Radius, Color);
}

void	  G2bAdaFruitRA8875_800x480::DrawCircle(int16_t XPos, int16_t YPos, int16_t Radius, uint16_t Color)
{
	AdaTFT->drawCircle(XPos, YPos, Radius, Color);
}

void    G2bAdaFruitRA8875_800x480::DrawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint16_t Color)
{
