...
//Basic Init function
void TouchCalibrationGen::initTFT(G2bAdaFruitRA8875* tft2, int DefaultState)
{
    tft=tft2;
...
int TouchCalibrationGen::displayScan()
{
...
int TouchCalibrationGen::clickHandler(int objUID)
{
    switch (objUID){
...
int TouchCalibrationGen::variableScan()
{
...
void TouchCalibrationGen::initObjects()
{
  ...
  Indicator_Light_inst[1].XPos=392;
  Indicator_Light_inst[1].YPos=432;
  ...
  Indicator_Light_inst[2].XPos=752;
  Indicator_Light_inst[2].YPos=232;
  ...
  Label_inst[1].UID=5;
  Label_inst[1].XPos=351;
  Label_inst[1].YPos=363;
  ...
  Label_inst[2].UID=6;
  Label_inst[2].XPos=686;
  Label_inst[2].YPos=260;
  ...
  Label_inst[4].UID=10;
  Label_inst[4].XPos=351;
  Label_inst[4].YPos=387;
  ...
  Label_inst[5].UID=11;
  Label_inst[5].XPos=686;
  Label_inst[5].YPos=284;
  ...
  Label_inst[6].UID=12;
  Label_inst[6].XPos=211;
  Label_inst[6].YPos=30;
  ...
  Label_inst[7].UID=13;
  Label_inst[7].XPos=211;
  Label_inst[7].YPos=57;
  ...
  Label_inst[8].UID=14;
  Label_inst[8].XPos=211;
  Label_inst[8].YPos=84;
...
void TouchCalibrationGen::stateUpdateObjects(int NewState)
{
...
int TouchCalibrationGen::clickChecker()
{
     if (tft->touched())
     {
         uint16_t RawX;
